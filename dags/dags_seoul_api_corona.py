...
with DAG(
    ...
    tb_corona19_count_status = SeoulApiToCsvOperator(
        ...
        path='/opt/airflow-study/files/TbCorona19CountStatus/{{data_interval_end.in_timezone("Asia/Seoul") | ds_nodash }}',
    ...
    tv_corona19_vaccine_stat_new = SeoulApiToCsvOperator(
        ...
        path='/opt/airflow-study/files/tvCorona19VaccinestatNew/{{data_interval_end.in_timezone("Asia/Seoul") | ds_nodash }}',
